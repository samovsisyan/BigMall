...
class BigOrder extends Component {
  render() {
    return (
      <Modal show={false} className={classes.bigOrder}>
        ...
        <Modal.Body className="p-0">
          ...
          <Button onClick={false} className={`shadow-none border-0 w-100 m-0 ${classes.bigOrder__success}`}>
                      Понятно
          </Button>
