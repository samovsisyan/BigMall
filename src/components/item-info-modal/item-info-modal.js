...
class ItemInfoModal extends Component {
  static propTypes = {
    ...
    updateItemUnits: PropTypes.func,
  ...
  render() {
    ...
    return (
      <div>
        {show == true ?
          <Modal show={show} onHide={this.handleClose} className={classes.itemModal}>
            <Modal.Header className="p-0 border-0" closeButton>
            </Modal.Header>
            <Modal.Body className="p-0">
              <Row className="d-flex flex-wrap">
                ...
                <Col sm={6} className="d-flex flex-column">
                  ...
                  <div className="flex-grow-1"><h3 className={classes.itemModal__title}>Овёс "Образ Жизни Алтая"
                    голозёрный</h3><p className={classes.itemModal__weight}>1 шт. 500г</p>
                  </div>
                  <div>
                    <p className={classes.itemModal__price}>16 200 AMD</p>
                    <p className={`m-0 ${classes.itemModal__oldPrice}`}>18 200 AMD</p>
              ...
              <Row className={`align-items-center ${classes.saveInBascet}`}>
                <Col sm={6} className="pl-0">
                  <div
                    className={`d-flex flex-wrap align-items-start justify-content-between ${classes.checkItem}`}>
                    <Form.Group
                      className={`position-relative overflow-hidden mb-0 ${classes.checkItem__item}`}>
                      <input type="radio" className={`position-absolute ${classes.checkItem__item__radio}`} name="radio"/>
                      <Form.Label
                        className={`d-flex align-items-center justify-content-center w-100 h-100 mb-0 ${classes.checkItem__item__label}`}>
                        <img className="img-fluid w-100 h-100" src="./images/item.png" alt=""/>
                      </Form.Label>
                    ...
                    <Form.Group
                      className={`position-relative overflow-hidden mb-0 ${classes.checkItem__item}`}>
                      <input type="radio" className={`position-absolute ${classes.checkItem__item__radio}`} name="radio"/> <Form.Label className={`d-flex align-items-center justify-content-center w-100 h-100 mb-0 ${classes.checkItem__item__label}`}><img className="img-fluid w-100 h-100" src="./images/item.png" alt=""/></Form.Label>
                    </Form.Group>
                    <Form.Group
                      className={`position-relative overflow-hidden mb-0 ${classes.checkItem__item}`}>
                      <input type="radio" className={`position-absolute ${classes.checkItem__item__radio}`} name="radio"/>
                ...
                <Col sm={6}>
                  <div
                    className={`d-flex align-items-end mx-auto h-100 ${classes.checkItem__item__countContainer}`}>
                    <Button onClick={this.decrementBtn} type="button" className={`d-flex align-items-center justify-content-center bg-transparent shadow-none rounded-circle flex-shrink-0 ${classes.checkItem__item__countContainer__minus}`}>
                      <svg width="14" height="4" viewBox="0 0 14 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 2H12" stroke="#222C54" strokeWidth="2.2" strokeLinecap="round"/>
                      </svg>
                    </Button>
                    <Form.Group className="m-0">
                      <Form.Control type="text" className={`border-0 m-0 text-center shadow-none flex-shrink-0 d-flex align-items-center justify-content-center  ${classes.checkItem__item__countContainer__number}`} value={this.state.counter}/>
                    </Form.Group>
                    <Button onClick={this.incrementBtn} type="button" className={`d-flex align-items-center justify-content-center shadow-none rounded-circle flex-shrink-0 border-0 ${classes.checkItem__item__countContainer__plus}`}>
                            ...
                            <Col sm={6} className="pl-0">
                                <div
                                    ...
                                    <Form.Group
                                        className={`position-relative overflow-hidden mb-0 ${classes.checkItem__item}`}>
                                        <input type="radio"
                                               className={`position-absolute ${classes.checkItem__item__radio}`}
                                               name="radio"/>
                                        <Form.Label
                                            className={`d-flex align-items-center justify-content-center w-100 h-100 mb-0 ${classes.checkItem__item__label}`}>
                                            <img className="img-fluid w-100 h-100" src="./images/item.png" alt=""/>
