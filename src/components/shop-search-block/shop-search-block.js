...
class ShopSearchBlock extends Component {
<<<<<<< HEAD
  constructor(props) {
    super(props);
    this.state = {
        ...
        <Container>
          <Row>
            <div className={`bg-white overflow-hidden ${classes.categories}`}>
              ...
              <Button type="button" className={`w-100 border-0 shadow-none d-flex align-items-center justify-content-between  ${classes.categories__btn}`}>
                Категории
                <span
                  className={`rounded-circle flex-shrink-0 d-flex align-items-center justify-content-center ${classes.categories__btn__icon}`}>
                  <svg width="11" height="7" viewBox="0 0 11 7" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.80005 1.93281L5.53338 5.13281L9.26672 1.93281" stroke="white" strokeWidth="2.2" strokeLinecap="round"/></svg></span></Button>
              <CategoriesModalItem/>
            </div>
            <div className="d-flex justify-content-end flex-column flex-grow-1">
              ...
              <div className="d-flex flex-wrap">
                <InputGroup
                  className={`overflow-hidden bg-white border-none flex-grow-1 ${classes.search}`}>
                  <FormControl
                  ...
                  />
                  <InputGroup.Append>
                    <Button variant="outline-secondary" className={`rounded-circle border-0 p-0 shadow-none ${classes.search__btn}`}>
                ...
                <Form.Group controlId="formBasicCheckbox" onChange={this.checkFilters} onClick={this.openFilter} className={`d-flex position-relative align-items-center justify-content-between border-0 mb-0 ${classes.filterBtn}`}>
                  Фильтр
                  <input type="checkbox" className={`position-absolute w-100 h-100 p-0 ${classes.filterBtn__checkbox}`}/>
                  <Form.Label
                    className={`${classes.filterBtn__icon}`}>
                    <svg className="" width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {filter == true ?
              <div className={`d-flex flex-wrap w-100 ${classes.filtersBlock}`}>
                <CustomSelect/>
                <CustomSelect/>
                <CustomSelect/>
                <CustomSelect/>
                    ...
                    <Row>
                        ...
                        <div className={`d-flex flex-wrap w-100 ${classes.filtersBlock}`}>
                            ...
                            <Button type="button" variant="link"
                                    className={`text-decoration-none ml-auto ${classes.resetFilters}`}>
                                Очистить все фильтры
                            </Button>
                        </div>
                           : null }
